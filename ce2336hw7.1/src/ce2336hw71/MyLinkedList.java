...
/*
 *
 * Add the following methods to the MyLinkedList code this is found
 ...
 *    * return the object that is contained in the removed node. */
  ...
  //remove all; removes first element, stores it as temp, and checks equality
  //to the element in c. If not equal, puts it in the back of the list
  public boolean removeAll(java.util.Collection<?> c){
      boolean status = false;
      for(Object o:c){
          for(int i=0;i<size;i++){
              E temp = this.removeFirst();
              if(temp != o){
                  this.addLast(temp);
                  status = false;
              }
